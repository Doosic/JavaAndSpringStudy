...
class GeneralExceptionTest {
    ...
    static Stream<Arguments> givenException_whenInstantiating_thenContainsRelevantInformation() {
        ...
        return Stream.of(
                ...
                arguments(new GeneralException(errorCode), errorCode.getMessage(), ErrorCode.INTERNAL_ERROR),
                arguments(new GeneralException(errorCode, t), errorCode.getMessage() + " - " + t.getMessage(), ErrorCode.INTERNAL_ERROR)
        );
    }
}